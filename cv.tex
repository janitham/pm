...
\begin{entrylist}
  \entry
    ...
    {Working as a Software Engineer and playing Software Engineer role in Product development and DevOps team. Cambio Software Engineering is committed to define and build the e-health generation. "Cambio" is the first company to have developed a platform, "Cambio Spider", that makes it possible to integrate all IT-support in IT-support in a health-care organization. I worked in a very challenging environment because I had to research a lot and complete the tasks in the limited time given. In that tasks I used various technologies and strategies. \\I developed applications using \textbf{Java, Spring, Hibernate, EJB, AngularJs, MsSql, Junit, Mokito, MsSql, MySql} and various latest technologies. Also I exposed to many "DevOps" technologies in this period \textbf{(Docker, Maven-plugins, Maven, Jenkins, Nexus, Git, Subversion, SonarQube)}.}
\\
  \entry
    {Oct. 15 - Mar.16}
    {Internship}
