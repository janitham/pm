...
\begin{entrylist}
	...
	{This is a sub-project of "Stacker" project. This application stores the delivery information. Snooper provides and Restful-API and GUI to do the 			necessary operations. This is a micro-services based application. It is used Spring-cloud \& Docker \textbf{(Java-8, Spring-cloud, Spring-		boot, zuul-proxy, Hibernate, AngularJs, Docker, Gulp, Micro-Services, SpringJunit, SonarQube, MySql, Redis, ELK-STACK)}}
	\\
	\entry
    {}
	{Stacker}    
